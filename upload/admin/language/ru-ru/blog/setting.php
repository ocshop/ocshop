...
$_['entry_customer_blog_search']       = 'Отслеживать поисковые запросы покупателей';
$_['entry_sitemap']                    = 'Включить карту сайта';
$_['entry_cache_status']               = 'Включить кэш';
...
$_['help_customer_blog_search']        = 'Если да, то будет вестись статистика поисковых запросов покупателей. Статистику вы можете просматривать в разделе: Отчёты/Покупатели/Поиск покупателей по блогу.';
$_['help_sitemap']                     = 'Если да, то будут выводиться ссылки на категории блога на странице карты сайта.';
$_['help_cache_status']                = 'Если да, то запросы на выборку статей будут кэшироваться.';
