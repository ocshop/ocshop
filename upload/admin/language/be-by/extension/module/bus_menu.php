...
$_['text_design_st']                        = 'Стандартны (Дызайн модуля - Bootstrap 3)';
...
$_['button_link_add_group']                 = 'Націсніце на кнопку для ўключэння магчымасці групавога дадання катэгорый, гэта значыць даданне абранай катэгорыі з падкатэгорыі, калі яны ёсць.';
