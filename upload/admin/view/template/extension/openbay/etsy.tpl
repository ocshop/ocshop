...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <?php } else { ?>
      <div class="col-md-3 text-center">
        <div class="well"> <a href="https://account.openbaypro.com/etsy/apiRegister/" rel="noreferrer noopener" target="_blank"> <span class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i> <i class="fa fa-star fa-stack-1x"></i> </span>
