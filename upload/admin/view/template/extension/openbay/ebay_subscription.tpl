        ...
        $.each(json.plans, function(key,val){
          ...
          if (val.myplan == 1){
            ...
            if (val.user_plan_id == 1) {
              ...
              htmlInj += '<td>';
              htmlInj += '<a href="https://uk.openbaypro.com/account/live/subscription_setup.php?plan_id='+val.user_plan_id+'&subscriber_id=<?php echo $obp_token;?>" class="btn btn-primary" rel="noreferrer noopener" target="_blank"><i class="fa fa-arrow-right fa-lg"></i> <?php echo $button_plan_change; ?></a>';
              htmlInj += '</td>';
            }
          }
          htmlInj += '</tr>';
